...
| ------------ | ----------------------------------------------------------------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ucp          | [UCP Response Checkout](/2026-01-11/specification/reference/#ucp-response-checkout) | **Yes**  | Protocol metadata for discovery profiles and responses. Uses slim schema pattern with context-specific required fields.                                                                                                                                         |
| id           | string                                                                              | **Yes**  | Unique identifier of the checkout session.                                                                                                                                                                                                                      |
| line_items   | Array\[[Line Item](/2026-01-11/specification/reference/#line-item)\]                | **Yes**  | List of line items being checked out.                                                                                                                                                                                                                           |
| buyer        | [Buyer](/2026-01-11/specification/reference/#buyer)                                 | No       | Representation of the buyer.                                                                                                                                                                                                                                    |
...
| totals       | Array\[[Total](/2026-01-11/specification/reference/#total)\]                        | **Yes**  | Different cart totals.                                                                                                                                                                                                                                          |
| messages     | Array\[[Message](/2026-01-11/specification/reference/#message)\]                    | No       | List of messages with error and info about the checkout session state.                                                                                                                                                                                          |
| links        | Array\[[Link](/2026-01-11/specification/reference/#link)\]                          | **Yes**  | Links to be displayed by the platform (Privacy Policy, TOS). Mandatory for legal compliance.                                                                                                                                                                    |
...
| payment      | [Payment](/2026-01-11/specification/reference/#payment)                             | **Yes**  | Payment configuration containing handlers.                                                                                                                                                                                                                      |
| order        | [Order Confirmation](/2026-01-11/specification/reference/#order-confirmation)       | No       | Details about an order created for this checkout session.                                                                                                                                                                                                       |
...
| Name          | Type                                                                             | Required | Description                                                                                                                                  |
| ------------- | -------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| ucp           | [UCP Response Order](/2026-01-11/specification/reference/#ucp-response-order)    | **Yes**  | Protocol metadata for discovery profiles and responses. Uses slim schema pattern with context-specific required fields.                      |
...
| line_items    | Array\[[Order Line Item](/2026-01-11/specification/reference/#order-line-item)\] | **Yes**  | Immutable line items — source of truth for what was ordered.                                                                                 |
| fulfillment   | object                                                                           | **Yes**  | Fulfillment data: buyer expectations and what actually happened.                                                                             |
| adjustments   | Array\[[Adjustment](/2026-01-11/specification/reference/#adjustment)\]           | No       | Append-only event log of money movements (refunds, returns, credits, disputes, cancellations, etc.) that exist independently of fulfillment. |
| totals        | Array\[[Total](/2026-01-11/specification/reference/#total)\]                     | **Yes**  | Different totals for the order.                                                                                                              |
...
| Name                   | Type                                                                                   | Required | Description                                                                                                                                                                                                                |
| ---------------------- | -------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| handlers               | Array\[[Payment Handler](/2026-01-11/specification/reference/#payment-handler)\]       | **Yes**  | Processing configurations that define how payment instruments can be collected. Each handler specifies a tokenization or payment collection strategy.                                                                      |
...
| Name         | Type                                                                          | Required | Description                                                   |
| ------------ | ----------------------------------------------------------------------------- | -------- | ------------------------------------------------------------- |
| payment_data | [Payment Instrument](/2026-01-11/specification/reference/#payment-instrument) | **Yes**  | Matches a specific instrument type based on validation logic. |
...
| identity    | [Payment Identity](/2026-01-11/specification/reference/#payment-identity) | No       | The participant this token is bound to. Required when acting on behalf of another participant (e.g., agent tokenizing for merchant). Omit when the authenticated caller is the binding target. |
...
| billing_address       | [Postal Address](/2026-01-11/specification/reference/#postal-address)         | No       | The billing address associated with this payment method.                                                                                                           |
| credential            | [Payment Credential](/2026-01-11/specification/reference/#payment-credential) | No       | Container for sensitive payment data. Use the specific schema matching the 'type' field.                                                                           |
...
| destination    | [Postal Address](/2026-01-11/specification/reference/#postal-address) | **Yes**  | Delivery destination address.                                                                               |
...
| Name              | Type                                                                                                       | Required | Description                         |
| ----------------- | ---------------------------------------------------------------------------------------------------------- | -------- | ----------------------------------- |
| methods           | Array\[[Fulfillment Method](/2026-01-11/specification/reference/#fulfillment-method)\]                     | No       | Fulfillment methods for cart items. |
| available_methods | Array\[[Fulfillment Available Method](/2026-01-11/specification/reference/#fulfillment-available-method)\] | No       | Inventory availability hints.       |
...
This object MUST be one of the following types: [Shipping Destination](/2026-01-11/specification/reference/#shipping-destination), [Retail Location](/2026-01-11/specification/reference/#retail-location).
...
| options            | Array\[[Fulfillment Option](/2026-01-11/specification/reference/#fulfillment-option)\] | No       | Available fulfillment options for this group.                          |
...
| destinations            | Array\[[Fulfillment Destination](/2026-01-11/specification/reference/#fulfillment-destination)\] | No       | Available destinations. For shipping: addresses. For pickup: retail locations.                               |
| selected_destination_id | ['string', 'null']                                                                               | No       | ID of the selected destination.                                                                              |
| groups                  | Array\[[Fulfillment Group](/2026-01-11/specification/reference/#fulfillment-group)\]             | No       | Fulfillment groups for selecting options. Agent sets selected_option_id on groups to choose shipping method. |
...
| totals                    | Array\[[Total](/2026-01-11/specification/reference/#total)\] | **Yes**  | Fulfillment option totals breakdown.                                       |
...
| --------- | ------------------------------------------------------------ | -------- | ------------------------------------------------------ |
| id        | string                                                       | **Yes**  |                                                        |
| item      | [Item](/2026-01-11/specification/reference/#item)            | **Yes**  |                                                        |
| quantity  | integer                                                      | **Yes**  | Quantity of the item being purchased.                  |
| totals    | Array\[[Total](/2026-01-11/specification/reference/#total)\] | **Yes**  | Line item totals breakdown.                            |
...
This object MUST be one of the following types: [Message Error](/2026-01-11/specification/reference/#message-error), [Message Warning](/2026-01-11/specification/reference/#message-warning), [Message Info](/2026-01-11/specification/reference/#message-info).
...
| item      | [Item](/2026-01-11/specification/reference/#item)            | **Yes**  | Product data (id, title, price, image_url).                                                                                                                                |
...
This object MUST be one of the following types: [Token Credential](/2026-01-11/specification/reference/#token-credential), [Card Credential](/2026-01-11/specification/reference/#card-credential).
...
This object MUST be one of the following types: [Card Payment Instrument](/2026-01-11/specification/reference/#card-payment-instrument).
...
| address | [Postal Address](/2026-01-11/specification/reference/#postal-address) | No       | Physical address of the location. |
...
| Name                   | Type   | Required | Description                                                |
| ---------------------- | ------ | -------- | ---------------------------------------------------------- |
| merchant_authorization | string | **Yes**  | Merchant's signature proving checkout terms are authentic. |

#### AP2 Complete Request Object

| Name             | Type   | Required | Description                                      |
| ---------------- | ------ | -------- | ------------------------------------------------ |
| checkout_mandate | string | **Yes**  | SD-JWT+kb proving user authorized this checkout. |
...
| Name         | Type          | Required | Description                                                                                                                                                                                                                                                     |
| ------------ | ------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ucp          | object        | **Yes**  | UCP metadata for checkout responses.                                                                                                                                                                                                                            |
| id           | string        | **Yes**  | Unique identifier of the checkout session.                                                                                                                                                                                                                      |
...
| expires_at   | string        | No       | RFC 3339 expiry timestamp. Default TTL is 6 hours from creation if not sent.                                                                                                                                                                                    |
| continue_url | string        | No       | URL for checkout handoff and session recovery. MUST be provided when status is requires_escalation. See specification for format and availability requirements.                                                                                                 |
| payment      | object        | **Yes**  | Payment configuration containing handlers.                                                                                                                                                                                                                      |
| order        | object        | No       | Details about an order created for this checkout session.                                                                                                                                                                                                       |
| ap2          | object        | No       | AP2 extension data including merchant authorization.                                                                                                                                                                                                            |

#### Complete Checkout Request with AP2

| Name | Type   | Required | Description                                    |
| ---- | ------ | -------- | ---------------------------------------------- |
| ap2  | object | No       | AP2 extension data including checkout mandate. |
...
| services     | object     | **Yes**  | Service definitions keyed by reverse-domain service name. |
| capabilities | Array[any] | **Yes**  | Supported capabilities and extensions.                    |
